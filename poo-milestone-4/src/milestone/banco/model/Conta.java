...
public class Conta {
    ...
    public void sacar(BigDecimal valor) {
        if (status && valor.compareTo(new BigDecimal(0)) == 1 && valor.compareTo(saldo) == -1) {
    ...
    public void transferir(Conta destino, BigDecimal valor) {
    	if (status && destino.status && valor.compareTo(new BigDecimal(0)) == 1 && valor.compareTo(saldo) == -1) {
